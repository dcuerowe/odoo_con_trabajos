...
3. Calcula la primera fila libre a partir de la referencia de la tabla.
4. Escribe `resumen` (lista de listas) celda por celda.
...
> las columnas de la tabla de Excel, ya que la escritura es posicional (`column=j+1`). No
> hay validación de cabeceras.
