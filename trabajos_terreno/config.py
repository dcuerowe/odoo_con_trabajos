...
# Carpeta destino de los informes PDF (mismo drive que EXCEL_URL, subcarpeta "Informes").
# La URL final por archivo es f"{INFORMES_BASE_URL}/{nombre_url_encodeado}.pdf:/content".
INFORMES_BASE_URL = 'https://graph.microsoft.com/v1.0/drives/b!_FsYntHkCECelI9711VeyMbyPx4aLChPm9Ub1jmcZ_XSssm7ywXaR6lOcXtuV77w/root:/Customer%20Experience%2FModelos%20de%20datos%2FModelo%20-%20%20Dashboard%20clientes%2FInformes'
